...
-(void)createView:(NSString *)title{
    //生成日期选择器
    _datePickerView=[[UIView alloc] initWithFrame:CGRectMake(0,HEIGHT(self)-306 + 40,WIDTH(self),305 - 40)];
    ...
    UIButton *dateCancleButton=[[UIButton alloc] initWithFrame:CGRectMake(PADDING,8,44,44 - 16)];
    [dateCancleButton addTarget:self action:@selector(dateCancleClick) forControlEvents:UIControlEventTouchUpInside];
    dateCancleButton.layer.masksToBounds = YES;
    dateCancleButton.layer.cornerRadius = 3.0f;
//    dateCancleButton.backgroundColor = UIColorFromRGB(0xff4c4c4c);
    dateCancleButton.backgroundColor = [UIColor colorWithRed:43/255.0 green:100/255.0 blue:150/255.0 alpha:0.8];
...
//        [dateCancleButton setImageEdgeInsets:UIEdgeInsetsMake(12, 12, 12,12)];
    ...
    dateConfirmButton.layer.masksToBounds = YES;
    dateConfirmButton.layer.cornerRadius = 3.0f;
//    dateConfirmButton.backgroundColor = UIColorFromRGB(0xff4c4c4c);
    dateConfirmButton.backgroundColor = [UIColor colorWithRed:43/255.0 green:100/255.0 blue:150/255.0 alpha:0.8];
    ...
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, MaxY(dateCancleButton) + 8, WIDTH(self), kLineHeight)];
...
//    [_datePickerView addSubview:lineView1];
    ...
    [_calendarBtn setTitleColor:[UIColor blackColor] forState:UIControlStateSelected];
